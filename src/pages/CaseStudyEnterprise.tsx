                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-white rounded-lg p-4 shadow-md">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">+12%</span>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 shadow-md">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">+8%</span>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 shadow-md">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">+23%</span>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 shadow-md">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">+0.02%</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link 
                to="/contact?subject=TOGAF Enterprise Architecture&template=enterprise-architecture#contact-form" 
                className="btn bg-white text-gray-700 hover:bg-gray-50"
              >
